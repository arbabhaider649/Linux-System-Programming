...
SVC_NAME="actions.runner.arbabhaider649-Linux-System-Programming.mystery.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (arbabhaider649-Linux-System-Programming.mystery)"
